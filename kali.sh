...
#                                                             #
#    e.g. # bash kali.sh --osx --burp --openvas --keyboard us #
#                             ---                             #
...
##  Alt Method: curl -s -L -k https://raw.github.com/SnakeMind/kali-postinstall/master/kali_postinstall.sh > kali.sh | nohup bash
################################################################################
fi
